...
public class Produto implements Serializable {
	...
	private List<Categoria> categorias = new ArrayList<>();
	  ...
	  private Set<ItemPedido> itens = new
	  HashSet<>();
	...
	public Produto(Integer id, String nome, Double preco) {
		...
		@JsonIgnore
	  public List<Pedido> getPedidos(){ List<Pedido> lista = new ArrayList<>();
	 for(ItemPedido x : itens) { lista.add(x.getPedido()); } return lista;
