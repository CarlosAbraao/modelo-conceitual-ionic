...
create table cliente (id int4 generated by default as identity, cpf_ou_cnpj varchar(255), email varchar(255), nome varchar(255), tipo_cliente int4, primary key (id));
...
create table pagamento (pedido_id int4 not null, estado_pagamento int4, primary key (pedido_id));
create table pagamento_com_boleto (data_vencimento timestamp, datapagamento timestamp, pedido_id int4 not null, primary key (pedido_id));
...
create table produtos_categoria (produto_id int4 not null, categoria_id int4 not null);
...
alter table if exists produtos_categoria add constraint FKdyjwrcjipbwcdq0tf5bjylbdg foreign key (categoria_id) references categoria;
alter table if exists produtos_categoria add constraint FKt7na2punkq9uq3i2flol67ing foreign key (produto_id) references produto;
